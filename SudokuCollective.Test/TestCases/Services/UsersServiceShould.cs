...
namespace SudokuCollective.Test.TestCases.Services
{
	internal class UsersServiceShould
	{
		...
		public async Task GetUser()
		{
			...
			Assert.That((User)result.Payload[0], Is.TypeOf<TranslatedUser>());
		}
		...
		public async Task RequestPasswordReset()
		{
			...
			// Assert
			Assert.That(result.IsSuccess, Is.True);
			Assert.That(result.Message, Is.EqualTo("Processed password reset request, please check your email"));
		}
