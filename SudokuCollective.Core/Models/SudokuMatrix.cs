...
namespace SudokuCollective.Core.Models
{
    public class SudokuMatrix : ISudokuMatrix
    {
        ...
        public void SetDifficulty(IDifficulty difficulty = null)
        {
            ...
            {
                patterns.Add([1, 2, 4, 5, 9, 10, 13, 24, 25, 26, 28, 29, 38, 41, 44, 52, 54, 56, 57, 58, 69, 72, 73, 77, 78, 80, 81]);
                patterns.Add([1, 2, 6, 9, 12, 15, 16, 23, 26, 28, 31, 32, 40, 42, 50, 51, 54, 56, 59, 66, 67, 70, 73, 76, 80, 81]);
                patterns.Add([1, 3, 5, 11, 14, 17, 19, 24, 25, 31, 34, 36, 37, 38, 44, 45, 46, 48, 51, 57, 58, 63, 65, 68, 71, 77, 79, 81]);
                patterns.Add([1, 3, 8, 11, 14, 16, 20, 23, 24, 25, 30, 36, 40, 41, 42, 46, 52, 57, 58, 59, 62, 66, 68, 71, 74, 79, 81]);
                patterns.Add([1, 4, 8, 14, 16, 20, 23, 24, 30, 33, 34, 35, 37, 41, 45, 47, 48, 49, 52, 58, 59, 62, 66, 68, 74, 78, 81]);
                patterns.Add([1, 4, 19, 11, 15, 24, 25, 27, 31, 33, 35, 36, 39, 43, 46, 47, 49, 51, 55, 57, 58, 67, 71, 72, 78, 81]);
                ...
                patterns.Add([1, 8, 10, 13, 16, 17, 18, 20, 24, 28, 32, 38, 40, 41, 42, 44, 50, 54, 58, 62, 64, 65, 66, 69, 72, 74, 81]);
                ...
                patterns.Add([2, 5, 9, 10, 16, 19, 21, 24, 27, 31, 34, 35, 40, 42, 47, 48, 51, 55, 58, 61, 63, 65, 72, 73, 77, 80]);
                patterns.Add([2, 5, 18, 20, 22, 26, 27, 31, 32, 35, 38, 39, 40, 42, 43, 44, 47, 50, 51, 55, 56, 60, 62, 64, 77, 80]);
                ...
                patterns.Add([4, 6, 7, 9, 10, 11, 18, 19, 23, 30, 33, 35, 37, 45, 47, 49, 52, 59, 63, 64, 71, 72, 73, 75, 76, 78]);
                patterns.Add([5, 7, 10, 11, 12, 15, 21, 22, 25, 26, 29, 32, 36, 37, 45, 46, 50, 53, 56, 57, 61, 62, 67, 70, 71, 72, 75, 77]);
                patterns.Add([5, 9, 12, 14, 16, 20, 21, 22, 26, 31, 34, 36, 39, 43, 46, 48, 51, 56, 60, 61, 62, 66, 68, 70, 73, 77]);
                patterns.Add([6, 9, 13, 14, 15, 17, 19, 27, 29, 30, 31, 34, 38, 44, 48, 51, 52, 53, 55, 63, 65, 67, 68, 69, 73, 76]);
